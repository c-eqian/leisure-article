...
declare const EpForm: {
    new (...args: any[]): import("vue").CreateComponentPublicInstance<Readonly<import("vue").ExtractPropTypes<{
        model: {
            type: import("vue").PropType<import("./type").IFormConfig["model"]>;
            default: () => void;
        };
        labelWidth: {
            type: import("vue").PropType<import("./type").IFormConfig["labelWidth"]>;
            default: string;
        };
        formItems: {
            type: import("vue").PropType<IFormItemConfig[]>;
            default: () => never[];
        };
    }>>, {
