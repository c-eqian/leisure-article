  ...
  <div class="about-section">
    ...
    <div class="about-content">
      <div class="about-item">
        ...
        ><span class="text">{{ aboutMe.location }}</span>
      </div>
      <div class="about-item">
        <span class="icon">💼</span
...
.about-section {
  ...
  h3 {
    ...
    font-size: 16px;
    font-weight: 600;
    color: var(--about-title-color, var(--text-white-soft, var(--text-white)));
    padding-bottom: 8px;
...
.about-item {
  ...
  gap: 12px;
  padding: 8px 0;
  border-bottom: 1px solid var(--about-item-border, rgba(255, 255, 255, 0.2));
...
.text {
  ...
  color: var(
    --about-text-color,
    var(--text-white-soft, rgba(255, 255, 255, 0.8))
  );
  flex: 1;
